...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var textToType = "Future Full Stack Developer";
  var index = 0;
  ...
  function eraseText() {
    ...
    if (textLength > 0) {
      p2Element.textContent = p2Element.textContent.substring(
        0,
        textLength - 1
      );
...
function sendEmail() {
  var emailAddress = "forrosueloharry17@gmail.com";
...
document
  .getElementById("toggleProjectsButton")
